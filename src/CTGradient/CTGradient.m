...
- (void)setBlendingMode:(CTGradientBlendingMode)mode;
{
    ...
    static const double input_value_range   [2] = { 0, 1 };						//range  for the evaluator input
    static const double output_value_ranges [8] = { 0, 1, 0, 1, 0, 1, 0, 1 };		//ranges for the evaluator output (4 returned values)
